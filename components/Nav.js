...
export default function Nav() {
  ...
  return (
        <>
          <nav
          className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center transition-all duration-400 ${scrolled
      ...
      >
        <a
          href="#"
          className={`font-serif text-lg tracking-wide transition-colors duration-300 ${scrolled ? 'text-black' : 'text-white'}`}
        >
...
{/* Desktop links */}
        ...
        {navLinks.map((link) => (
                ...
                className={`text-[0.7rem] font-medium tracking-[0.14em] uppercase transition-colors duration-300 ${scrolled
